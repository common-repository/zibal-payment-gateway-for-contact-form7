...
// Set Data -> Table Trans_ContantForm7
                ...
                if ($active_gateway == 'Zibal') {
                    ...
                    $result = zgcf7_postToZibal('request', json_encode($data));  
                    ...
                    if ($result["result"] == 100 && $Amount == $result["amount"]) {
                        ...
                        $tmp = 'خطایی رخ داده در اطلاعات پرداختی درگاه' . '<br>Error:' . $result["result"] . '<br> لطفا به مدیر اطلاع دهید <br><br>';
                        $tmp .= '<a href="' . get_option('siteurl') . '" class="mrbtn_red" > بازگشت به سایت </a>';
                        echo zgcf7_CreatePage_cf7('خطا در عملیات پرداخت', $tmp);
                    }
            }
